...
<form action="Importancia_insertar.php" method="POST">

  <h1>Agregar nivel de importacia</h1>
    <br>

    <div class="text-start">
        <label>Importancia</label>
        <input type="text" name="TxtImportancia" class="form-control"  required>
    </div>
<br><br>
  <button type="button" class="btn btn-lista"
            onclick="window.location.href='Importancia_listar.php'">
